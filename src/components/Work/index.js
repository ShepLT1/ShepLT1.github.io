  ...
  return (
    <Grid stackable centered id="work" >
      ...
      <Grid.Row columns={2}>
        ...
        <Grid.Column>
          <Project link="https://breakaway-vacay.herokuapp.com/" repo="https://github.com/MVC-5/breakaway" src={BreakawayThumbnail} title="Breakaway" brief="Breakaway is an app that increases productivity by helping create a culture and community of taking breaks. Managers can track employee PTO and employees can share experiences with this fun and seamless user experience." />
        </Grid.Column>
      </Grid.Row>
      <Grid.Row columns={2}>
        <Grid.Column>
          <Project link="https://sheplt1.github.io/Day-Planner/" repo="https://github.com/ShepLT1/Day-Planner" src={PlannerThumbnail} title="Day Planner" brief="Day Planner is a calendar application that allows the user to save events for each work hour of a selected day. Events are color-coded based on past, current, or upcoming hours and days." />
        </Grid.Column>
        <Grid.Column>
      ...
      <Grid.Row columns={2}>
        <Grid.Column>
          <Project link="https://sheplt1.github.io/hows-the-weather/" repo="https://github.com/ShepLT1/hows-the-weather" src={WeatherThumbnail} title="How's the Weather" brief="How's the Weather is a weather dashboard application utilizing search functionality to find current and projected weather conditions for user-selected cities." />
        </Grid.Column>
        <Grid.Column>
