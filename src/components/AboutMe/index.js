    ...
    <Grid stackable centered id="about">
      ...
      <Grid.Row>
        <Grid.Column id="about-col">
          <p>I'm an enthusiastic full-stack web developer proficient in Javascript-based technologies who loves diving into some solid code.</p>


          <p>Technology has fascinated me ever since I volunteered to set up the family computer as a young kid. My affection for creation also began early on, where I spent hours in my room building anything I could imagine out of legos. Web development allows me to combine these interests and I am eager to follow my growing passion.</p>
